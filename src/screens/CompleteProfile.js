    ...
    return (
      <View style={styles.cardContainer}>
        <View
          style={[
            styles.iconBorder,
            {borderColor: isActive ? 'black' : styles.iconBorder.borderColor},
          ]}>
          <Ionicons
            name={item?.icon}
            size={30}
        ...
        <TouchableOpacity
          ...
          <Text
            style={[
              styles.buttonText,
              {color: isActive ? 'black' : styles.buttonText.color},
            ]}>
            {isActive ? item.inactiveButtonTitle : item.activeButtonTitle}
          </Text>
        </TouchableOpacity>
      </View>
    );
